...
`Dockerfile` содержит отдельный production stage, сгенерированный Rails. Перед deployment необходимо настроить production ENV/credentials и Kamal под целевую инфраструктуру; deployment в рамках этого этапа не выполнялся.
